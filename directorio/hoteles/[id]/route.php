    ...
    switch ($method) {
        ...
        case 'GET':
            ...
            if ($result->num_rows === 0) {
                ...
                echo json_encode(['error' => 'Hotel no encontrado']);
                exit;
            }
        ...
        case 'POST':
            ...
            if (isset($data['_method']) && $data['_method'] === 'PUT') {
                ...
                echo json_encode(['message' => 'Hotel actualizado correctamente', 'id' => $id]);
            }
            break;
        ...
        case 'DELETE':
            ...
            echo json_encode(['message' => 'Hotel eliminado', 'id' => $id]);
            break;
